...
public class PStartAngajatFunctionar extends JFrame {
    ...
    private JFrame frame = new JFrame("Pagina de start client functionar");
    ...
    private JButton buttonListTranz = new JButton("Lista de tranzactii");
    private  JButton ButtonLogout = new JButton("LOGOUT");
    private JButton ButtonModificareDate = new JButton("Modificare date");
    private JButton buttonMSP= new JButton("Aprobare cereri carduri") ;
    public PStartAngajatFunctionar(String cnp) {
        this.cnp = cnp;
        ...
        //BUTONUL DE LISTA DE CLIENTI
        Button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                frame.dispose();
                //deschid pagina dorita
        ...
        buttonListTranz.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // inchid pag actuala
                frame.dispose();

                //deschidem PListTranz
                PListTranz plt = new PListTranz(cnp);
                plt.getFrame().setVisible(true);
            }
        });

        ButtonModificareDate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //ichide fereastra actuala
                frame.dispose();

                //deschid pagina de modificare date personale destinata unui angajat Functionar
                ModificareDatePersoanaleAngajatFunctionar mdf = new ModificareDatePersoanaleAngajatFunctionar(cnp);
                mdf.getFrame().setVisible(true);
            }
        });

        buttonMSP.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //ichide fereastra actuala
                frame.dispose();
                //deschid pagina de modificare date personale destinata unui angajat Functionar
                apCereCardAng mdf = new apCereCardAng(cnp);
                mdf.getFrame().setVisible(true);
            }
        });
        ...
        Button.setBounds(387, 50, 167, 23);
        contentPane.add(Button);

        buttonListTranz.setFont(new Font("Tahoma", Font.PLAIN, 15));
        buttonListTranz.setBounds(387, 100, 167, 23);
        contentPane.add(buttonListTranz);

        buttonMSP.setFont(new Font("Tahoma", Font.PLAIN, 15));
        buttonMSP.setBounds(387, 200, 167, 23);
        contentPane.add(buttonMSP);
        ...
        ButtonModificareDate.setBounds(387, 150, 167, 23);
