...
public class PAdaugareSuma extends JFrame {
	...
	private JFrame frame = new JFrame("Adaugare suma");
	private JPanel contentPane;
	private JTextField suma;
	JButton back = new JButton("BACK");
	JButton Button = new JButton("ADAUGA SUMA");
	private final JLabel mesaj = new JLabel("");

	public PAdaugareSuma(String iban, String cnp) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!ok) {
					...
					try {
						...
						ResultSet resultSet = statement.executeQuery("CALL adauga_fonduri ('"+iban+"','+"+ suma2 +"');");
