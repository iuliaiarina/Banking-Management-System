...
public class PCreeareContClient {
    ...
    private JFrame frame = new JFrame("Creeaza Cont Client");
    ...
    private JLabel l9 = new JLabel("Data Nasterii: ");
    private JLabel l10 = new JLabel("Sursa Venit: ");
    private JLabel l11 = new JLabel("Tranzactii Online: ");
    ...
    private JTextField t9 = new JTextField("Introduceti Data Nasterii");
    private JTextField t10 = new JTextField("Introduceti Sursa Venit");
    private JTextField t11 = new JTextField("1 pentru Da, 0 pentru NU");

    private JButton back = new JButton("BACK");
    private JButton creeare = new JButton("Creeaza Cont");

    public PCreeareContClient(String CNP) {
        ...
        creeare.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    statement.executeQuery("Call Creare_Client('"+t1.getText()+"' , '"+ t2.getText() + "' , '"+t3.getText()+"' , '"+t4.getText()+
                            "' , '"+ t5.getText() + "' , '" + t6.getText() + "' , '"+ t7.getText()+"' , '" + t8.getText()+"' , '" +t9.getText() +"' , '"
                    +t10.getText()+"' , '"+t11.getText() +"');");
                    statement.executeQuery("CALL creare_cont_curent ('ING', '"+t8.getText()+"');");
                }
