...
public class PCreeareContAngajat extends JFrame {
    ...
    public PCreeareContAngajat(String CNP) {
        ...
        creeare.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    statement.executeQuery("Call Creare_Angajat('"+t1.getText()+"' , '"+ t2.getText() + "' , '"+t3.getText()+"' , '"+t4.getText()+
                            "' , '"+ t5.getText() + "' , '" + t6.getText() + "' , '"+ t7.getText()+"' , '" + t8.getText()+"' , '" +t9.getText() +"' , '"
                            +t10.getText()+"' , '"+t11.getText() +"' , '"+t12.getText()+"');");
                   statement.executeQuery("CALL PROC_10('"+t8.getText()+"');");
                    statement.executeQuery("CALL creare_cont_curent ('BTRL', '"+t8.getText()+"');");
                }
